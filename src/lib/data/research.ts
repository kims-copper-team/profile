...
export const RESEARCH_PROJECTS: ResearchProject[] = [
  {
    id: "res-cu-ni-si",
    title: "Cu–Ni–Si–Co–Cr–Sn 합금 용체화 처리 및 시효 거동 연구",
    materialSystem: "Cu 합금계",
    objective:
      "용체화 처리 온도가 Cu–Ni–Si–Co–Cr–Sn 합금의 냉간 압연 가공 경화 및 시효 거동에 미치는 영향 규명",
    keywords: ["Cu–Ni–Si 합금", "용체화 처리", "냉간 압연", "가공 경화", "석출 경화"],
    processing: ["용해 주조", "용체화 처리", "냉간 압연", "시효 처리"],
    characterization: ["SEM", "EBSD", "XRD", "TEM", "인장시험", "경도 측정", "전기전도도"],
    keyFindings:
      "용체화 처리 온도에 따른 가공 경화 거동 및 시효 후 석출물 분포 차이 규명",
